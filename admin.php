...
<?php else: ?>
  ...
  <div class="panel">
    <a href="distribute.php" style="text-decoration:none;">
      <button type="button" style="width:100%; background:#111827; color:#fff; margin-bottom:10px;">📤 Send Room Details</button>
    </a>
