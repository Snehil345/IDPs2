...
<body>
  <div class="wrap">
    ...
    <div class="panel">
      ...
      <p class="notice notice-yellow" style="margin:14px 26px 0;">
        STEP 1 — MESSAGE <a href="https://t.me/<?= htmlspecialchars($bot_username) ?>" target="_blank" style="color:inherit;">@<?= htmlspecialchars($bot_username) ?></a> ON TELEGRAM &amp; TAP START, THEN BOOK BELOW
      </p>
